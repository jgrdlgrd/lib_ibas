...
$declareClass(LinkedList, {
  ...
  $List_methods(LinkedList, list, Pointer);
});
...
Object_t __LinkedList_iter(LinkedList_t list, int i);
Object_t __LinkedList_begin(LinkedList_t list);
Object_t __LinkedList_end(LinkedList_t list);
Object_t __LinkedList_find(LinkedList_t list, Pointer val);
Pointer __LinkedList_iterGet(LinkedList_t list, Object_t iter);
void __LinkedList_iterSet(LinkedList_t list, Object_t iter, Pointer val);
Object_t __LinkedList_iterNext(LinkedList_t list, Object_t iter);
Object_t __LinkedList_iterPrev(LinkedList_t list, Object_t iter);
Object_t __LinkedList_iterJump(LinkedList_t list, Object_t iter, int length);
void __LinkedList_iterInsert(LinkedList_t list, Object_t iter, Pointer val);
void __LinkedList_iterInsertAll(LinkedList_t list1, Object_t iter, LinkedList_t list2);
void __LinkedList_iterRemove(LinkedList_t list, Object_t iter);
